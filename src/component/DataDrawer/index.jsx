...
//   const [data, setData] = useState([])
  ...
  return (
    <Drawer open={openData?.visible} 
    onClose={onClose}
    footer={<>
    <Button onClick={()=>baseForm.submit()} type='primary'> 提交</Button>
    ...
    >
      <Form layout='vertical'
       ...
       >
        <Form.Item name='ID' label='身份证号' rules={[{ required: true,message:'请输入身份证号' }]}>
          <Input />
        </Form.Item>
        ...
        <Form.Item name='drivingSchool' label='驾校' rules={[{ required: true,message:'请输入驾校' }]}>
          <Input />
        </Form.Item>
